...
<center>
<a class="btn btn-outline-dark btn-lg" data-bs-toggle="modal" data-bs-target="#seis">6. Suma de vectores</a><br><br>
</center>


<!--MODAL PROBLEMA UNO-->
<div class="modal fade" id="seis" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">6. Suma de vectores</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="container-fluid">
                    <form action="seisAction.php" method="post">
                        <div class="row">


                        <center>
                                <div class="form-group">
                                    <label>Rellena los 5 datos del vector que se va a sumar con otros 2 generados de manera aleatoria: </label><br><br>
